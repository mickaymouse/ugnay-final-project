package ugnay.app.frontend.ui.register
...
import ugnay.app.backend.data.CivilStatus
import ugnay.app.backend.data.Gender
import ugnay.app.backend.data.User
import ugnay.app.backend.login.LoginRepository
import ugnay.app.backend.register.RegisterRepository
...
class RegisterFragment : Fragment() {
    ...
    private fun setupDropdowns() {
        ...
        val civilStatuses = arrayOf("Single", "Married", "Widowed", "Separated")
    ...
    private fun setupDatePicker() {
        binding.etRegisterDob.setOnClickListener {
            ...
            DatePickerDialog(requireContext(), { _, selectedYear, selectedMonth, selectedDay ->
                val date = String.format(java.util.Locale.US, "%04d-%02d-%02d", selectedYear, selectedMonth + 1, selectedDay)
